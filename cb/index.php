...
--> 
  ...
  <style>
    ...
    .card {height: 90%;}
    #container1 {border-radius: 5px; border: 1px solid #787878;padding: 20px; padding-left: 35px; padding-right: 35px;}
 ...
 <div class="col-lg-8"> <center><h4><strong>HR-аналитика</strong></h4></center> </div>
  ...
  <div class="row bg-dark">
   ...
   <div id="logo1" class="row bg-white">
	   ...
	   <div class="row bg-white">
	   <div class="col-lg-6">
	   <p><center><img src="../images/iee.png" class="img-circle" width="156" height="233"/></center></p>
	   </div>
	   <div class="col-lg-6">
	   <p></p>
				  <tr>
					<td><h2><strong>Иванова <br>Елена<br>Евгеньевна</strong></h2></td>
					<td><h5 style="color: black" ><p></p>Директор</h5></td>
				  </tr>
	   </div> 
	   </div>
...
<div class="dropdown text-center">
    ...
    <h5 class="text-white">Возглавляемое учреждение</h5>
    </button> 
    <div class="dropdown-menu">
	  <?
		  ...
		  .$obj->pck[$i]->l1.','.$obj->pck[$i]->l2.','.$obj->pck[$i]->l3.','.$obj->pck[$i ]->l4.','.$obj->pck[$i]->l5.','.$obj->pck[$i]->l6.','.$obj->pck[$i]->l7.','.$obj->pck[$i]->l8.','.$obj->pck[$i ]->l9.	  
...
<div class="card-body text-center"><h4 id="name1"></h4></div>
      ...
      <div class="row bg-dark">
	   ...
	   <div class="col-lg-12"><!-- l -->
			...
			<div id="card_l1" class="card  bg-dark text-white  rounded" >
    ...
    <script type="text/javascript">
      ...
      $(document).ready(function() {
        <?
		  ...
		  .$obj->pck[0]->l1.','.$obj->pck[0]->l2.','.$obj->pck[0]->l3.','.$obj->pck[0]->l4.','.$obj->pck[0]->l5.','.$obj->pck[0]->l6.','.$obj->pck[0]->l7.','.$obj->pck[0]->l8.','.$obj->pck[0]->l9.	  
		  ')';
          echo $Firts1;
		  ?>    
	//  $('#name2').innerHTML = '123';
...
Chart2 = new Chart($ctx2, {
	...
	document.getElementById('l1').innerHTML ="*Основные работники – "+l1+" ст. ("+l2+" чел.)";
	document.getElementById('l2').innerHTML ="Внутренние совместители – "+l3+" ст. ("+l4+" чел.)";
	document.getElementById('l3').innerHTML ="Внешние совместители – "+l5+" ст. ("+l6+" чел.)";
	document.getElementById('l4').innerHTML ="Совмещение – "+l7+" ст. ("+l8+" чел.)";
	document.getElementById('l5').innerHTML ="Вакантные ставки – "+l9;
