...
<div class="card-body text-center"><h4 id="name1"></h4></div>
   ...
   <div class="row bg-dark">
	   ...
	   <div class="col-lg-4"><!-- e -->
			<p></p>
			<div class="card border bg-dark text-white  rounded" >
			<div class="card-header text-center"> <h4> Развитие, чел.</div>
				<table text-align="center" style="width:100%">
				  <tr>
   ...
   <div class="row bg-dark">
       <div class="col-lg-4"><!-- f -->
			...
			<p></p>
			<div class="card border bg-dark text-white  rounded" >
			<div  class="card-header text-center"> <h4>Награды</h4> </div>
...
function PaintChart2(k1,k2,k3,k4,k5) {
 ...
 <footer>
      <div class="container-fluid">
        <div class="row">
		   <div class="col-lg-12"> <center><h6> <a href="#" data-toggle="tooltip" title=<? echo $xml_update_time ?>>&copy; 2022</a> </h6></center> </div>
