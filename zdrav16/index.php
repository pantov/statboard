...
<html lang="ru">
<head>
  <title>HR-аналитика (ZDRAV)</title>
 ...
 <div class="col-lg-8"> <center><h4><strong>HR-аналитика</strong></h4></center> </div>
  ...
  <div class="row bg-dark">
   ...
   <div id="logo1" class="row bg-white">
	   ...
	   <div class="row bg-white">
	   <div class="col-lg-6">
	   <p><center><img src="images/fio.png" class="img-circle" width="200" height="200"/></center></p>
	   </div>
	   <div class="col-lg-6">
	   <p></p>
				  <tr>
					<td><h2><strong>Фамилия <br>Имя  <br>Отчество </strong></h2></td>
					<td><h5 style="color: black" ><p></p>Должность</h5></td>
				  </tr>
	   </div> 
	   </div>
...
<div class="dropdown text-center">
    ...
    <h5 class="text-white">Учреждения здравохранения</h5>
    </button> 
